...
function venda(e){
    if (document.getElementById('mussarela').checked) {
        ...
        vendaMussarera = vendaMussarera + 25.00
        document.getElementById('resultadoMussarela').innerHTML = somaMussarela
        document.getElementById('vendaMussarela').innerHTML = vendaMussarera.toFixed(2)
    } else if (
        document.getElementById('mista').checked) {
        ...
        document.getElementById('calabresa').checked) {
